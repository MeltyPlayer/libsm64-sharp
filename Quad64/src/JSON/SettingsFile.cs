...
class SettingsFile {
  public static void SaveGlobalSettings(string profileName) {
    ...
    Directory
        .CreateDirectory(savePath); // Create directory if it doesn't exist!
  ...
  public static void LoadGlobalSettings(string profileName) {
    ...
    if (File.Exists(fp)) {
      ...
      if (o["EnableBackfaceCulling"] != null)
        Globals.doBackfaceCulling =
            bool.Parse(o["EnableBackfaceCulling"].ToString());
      if (o["DrawObjectModels"] != null)
        Globals.drawObjectModels =
            bool.Parse(o["DrawObjectModels"].ToString());
      if (o["RenderCollisionMap"] != null)
        Globals.renderCollisionMap =
            bool.Parse(o["RenderCollisionMap"].ToString());
      if (o["AutoLoadROMFile"] != null)
        Globals.autoLoadROMOnStartup =
            bool.Parse(o["AutoLoadROMFile"].ToString());
