...
partial class SelectComboPreset : Form {
  ...
  public SelectComboPreset(Level level,
                           int listType,
                           string columnText,
  ...
  private void
      listView1_DrawItem(object sender, DrawListViewItemEventArgs e) {
  ...
  private void listView1_DrawColumnHeader(object sender,
                                          DrawListViewColumnHeaderEventArgs
                                              e) {
    int x =
        180 - (TextRenderer.MeasureText(e.Header.Text, textFont).Width / 2);
  ...
  private void setReturnFromSpecialName(List<PresetMacroEntry> specialList,
                                        string label) {
  ...
  private ObjectComboEntry getObjectComboEntryFromName(
    ...
    foreach (ObjectComboEntry entry in level.LevelObjectCombos) {
      if (entry.Name.Equals(name) && modelID == entry.ModelID &&
      ...
      case 1:
        ReturnPresetMacro =
            level.MacroObjectPresets[
                getMacroPresetFromLabel(listView1.SelectedItems[0].Text) -
                0x1F];
        break;
      case 2:
        setReturnFromSpecialName(level.SpecialObjectPresets_8,
                                 listView1.SelectedItems[0].Text);
        break;
      case 3:
        setReturnFromSpecialName(level.SpecialObjectPresets_10,
                                 listView1.SelectedItems[0].Text);
        break;
      case 4:
        setReturnFromSpecialName(level.SpecialObjectPresets_12,
                                 listView1.SelectedItems[0].Text);
        break;
    }
    ClickedSelect = true;
  ...
  private void BeginUpdate(ListView lv) {
    ...
    OldEventMask =
        SendMessage(lv.Handle, EM_SETEVENTMASK, IntPtr.Zero, IntPtr.Zero);
  }
