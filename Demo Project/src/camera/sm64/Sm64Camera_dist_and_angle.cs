...
namespace demo.camera.sm64 {
  public partial class Sm64Camera {
     ...
     */
    public void vec3f_get_dist_and_angle(Vector3 from, Vector3 to, out float dist, out short pitch, out short yaw) {
      var x = to[0] - from[0];
      var y = to[1] - from[1];
      var z = to[2] - from[2];
     ...
     */
    public void vec3f_set_dist_and_angle(Vector3 from, ref Vector3 to, float dist, short pitch, short yaw) {
